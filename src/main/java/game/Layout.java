...
public class Layout {
    ...
    public void draw(Graphics2D g){
        ...
        g.drawString("Jugador 1", 90, 135);
        g.drawString("Jugador 2", 370, 135);
        g.drawString("Jugador 4", 90, 620);
        g.drawString("Jugador 3", 370, 620);
        //g.drawString("Instruction:", 550,300);
        //g.drawString("1.Presiona Enter Para Tirar dado.", 550,350);
        //g.drawString("2.Click izquierdo a la pieza a mover.", 550,400);
    }
}
